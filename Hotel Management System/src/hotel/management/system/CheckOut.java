...
public class CheckOut extends JFrame{
	...
	public CheckOut() throws SQLException {
		...
		lblCheckOut.setFont(new Font("Algerian", Font.BOLD, 20));
		lblCheckOut.setBounds(70, 20, 140, 35);
		...
		btnCheckOut.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String deleteSQL = "Delete from customer where number = "+id;
                                String q2 = "update room set availability = 'Available' where Room_no = "+s1;
