...
public class NewCustomer extends JFrame {
	...
	public NewCustomer() throws SQLException {
		...
		lblName.setFont(new Font("Algerian", Font.PLAIN, 25));
		lblName.setBounds(100, 11, 260, 53);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String status =  t5.getText();
                     ...
                     JOptionPane.showMessageDialog(null,"status is manadatry");
                     }if(Deposit.equals("")){
                     JOptionPane.showMessageDialog(null,"Deposit is manadatry");
                     }
                     else{ 
                         conn c = new conn();
                         String q1 = "insert into customer values('"+Id+"','"+Number+"','"+Name+"','"+Gender+"','"+country+"','"+room+"','"+status+"','"+Deposit+"')";
