            ...
            if(ae.getSource() == b1){
                ...
                String location = t5.getText();
                 ...
                 if(name.equals("")){
                     ...
                     JOptionPane.showMessageDialog(null,"Company is manadatry");
                     }if(brand.equals("")){
                     JOptionPane.showMessageDialog(null,"Brand is manadatry");
                     }if(available.equals("")){
                     JOptionPane.showMessageDialog(null,"Availibility is manadatry");
                     }if(location.equals("")){
                     JOptionPane.showMessageDialog(null,"Location ID is manadatry");
                     }
                     else{  
                         conn c = new conn();
                         String str = "INSERT INTO divers values( '"+name+"', '"+age+"', '"+gender+"','"+company+"', '"+brand+"', '"+available+"','"+location+"')";
