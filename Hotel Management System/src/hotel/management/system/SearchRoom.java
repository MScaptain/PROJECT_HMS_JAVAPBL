...
public class SearchRoom extends JFrame {
	...
	public SearchRoom() throws SQLException {
		...
		lblSearchForRoom.setFont(new Font("Algerian", Font.PLAIN, 30));
		lblSearchForRoom.setBounds(250, 11, 400, 50);
		contentPane.add(lblSearchForRoom);
		
		JLabel lblRoomAvailable = new JLabel("Room Bed Type:");
		lblRoomAvailable.setBounds(50, 93, 96, 14);
		...
		checkRoom.setBounds(400, 91, 205, 23);
