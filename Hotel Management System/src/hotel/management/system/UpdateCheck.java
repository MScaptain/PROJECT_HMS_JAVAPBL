...
public class UpdateCheck extends JFrame {
	...
	public UpdateCheck() throws SQLException {
		...
		lblUpdateCheckStatus.setFont(new Font("Algerian", Font.BOLD, 25));
		lblUpdateCheckStatus.setBounds(100, 11, 400, 25);
			...
			public void actionPerformed(ActionEvent e) {
				...
				conn c = new conn();
                            ...
                            try{
                                String total = "";
                                conn c  = new conn();
                                ResultSet rs2 = c.s.executeQuery("select * from room where Room_no = "+txt_ID.getText());
                                while(rs2.next()){
