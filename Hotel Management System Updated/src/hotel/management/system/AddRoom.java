    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                ...
                if(room.equals("")){
                     JOptionPane.showMessageDialog(null,"Room is manadatry");
                     }if(price.equals("")){
                     JOptionPane.showMessageDialog(null,"Price is manadatry");
                     }
                     else{         
                         conn c = new conn();
