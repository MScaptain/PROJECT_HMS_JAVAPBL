...
PreparedStatement pst = null;
	...
	public UpdateRoom() throws SQLException {
		...
		lblUpdateRoomStatus.setFont(new Font("Algerian", Font.BOLD, 25));
		lblUpdateRoomStatus.setBounds(75, 11, 400, 34);
		...
		b1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				conn c = new conn();
                            ...
                            try{
                                conn c  = new conn();
                                ResultSet rs2 = c.s.executeQuery("select * from room where Room_no = "+txt_Room.getText());
                                while(rs2.next()){
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) throws NumberFormatException {
				...
				try{
                                    conn c = new conn();
                                    String str = "update room set status = '"+txt_Status.getText()+"' where Room_no = "+txt_Room.getText();
                                     String str2 = "update room set Availability = '"+txt_Ava.getText()+"' where Room_no = "+txt_Room.getText();
